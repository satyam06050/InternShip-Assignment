...
abstract class $ActivityModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, ActivityType type, String title, DateTime timestamp});
}
...
class _$ActivityModelImpl implements _ActivityModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, type, title, timestamp);
...
abstract class _ActivityModel implements ActivityModel {
  const factory _ActivityModel(
      ...
      required final DateTime timestamp}) = _$ActivityModelImpl;
