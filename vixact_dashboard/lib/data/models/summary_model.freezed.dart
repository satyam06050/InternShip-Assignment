...
abstract class $SummaryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int totalVendors, int totalCollected, int totalOutstanding});
}
...
class _$SummaryModelImpl implements _SummaryModel {
  ...
  @override
  String toString() {
    return 'SummaryModel(totalVendors: $totalVendors, totalCollected: $totalCollected, totalOutstanding: $totalOutstanding)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, totalVendors, totalCollected, totalOutstanding);
...
abstract class _SummaryModel implements SummaryModel {
  const factory _SummaryModel(
      ...
      required final int totalOutstanding}) = _$SummaryModelImpl;
