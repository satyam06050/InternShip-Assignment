...
class _$EventModelImpl implements _EventModel {
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, name: $name, date: $date, vendorCount: $vendorCount, collected: $collected, pending: $pending, colorTag: $colorTag)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, date, vendorCount, collected, pending, colorTag);
...
abstract class _EventModel implements EventModel {
  const factory _EventModel(
      ...
      required final int vendorCount,
      required final int collected,
      required final int pending,
      required final String colorTag}) = _$EventModelImpl;
